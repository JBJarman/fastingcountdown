...
function calculateFast() {
  ...
  let start = new Date(nowDate.getFullYear(), nowDate.getMonth(), nowDate.getDate(), startHours, startMinutes);
  let end = new Date(nowDate.getFullYear(), nowDate.getMonth(), nowDate.getDate(), endHours, endMinutes);
  ...
  updateCountdown(end);
  updateProgress(new Date(), start, end);
